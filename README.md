...
#### Germán Adolfo Ojeda Padrón

## Creación de la Base de Datos
---
Primero creamos la base de datos con el comando

sqlite3 Tarea1.db

## Creación de la tabla
---
Con el siguiente comando creamos la tabla dentro de la base de datos.
```SQL
...
+----+-----------+--------+---------+------------+----------+
```
## Modificaciones (Updates y Deletes)
---
- Campos where Booleano = True eliminados
```SQL
...
- Texto modificado donde entero = 30
```SQL
...
- Campos donde entero = 50 eliminados
```SQL
...
- Incrementa en 10 el entero where booleano = False
```SQL
...
- Eliminando entradas donde Decimal < 50
```SQL
...
- Actualizar fecha de los campos restantes a la fecha actual
```SQL
