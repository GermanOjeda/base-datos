...
select * from libro as l, autor as a where a.id = l.autor_id and nombre regexp "ing$";
/**
No da resultado
**/
...
select l.*, a.nombre from libro as l, autor as a where l.autor_id = a.id and a.nombre regexp '[aeiouAEIOU].*[aeiouAEIOU]';
/**
+--------+-----------------+----------+-----------------+--------+---------------+
...
select * from libro where precio regexp '^.{5}$';
/**
+--------+-----------------------------------+----------+---------------------------------------------+--------+
| codigo |              titulo               | autor_id |                  editorial                  | precio |
+--------+-----------------------------------+----------+---------------------------------------------+--------+
...
select * from libro where precio regexp '^0.{5}$';
/**
No da resultado
**/
...
select * from autor where nombre regexp '\D\W';
/**
+----+-----------------+
| id |     nombre      |
+----+-----------------+
